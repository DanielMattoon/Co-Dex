...
export const GAME_MAP_CONFIG: Record<string, GameMapConfig> = {
  ...
  leafgreen: { region: 'kanto', version: 'leafgreen' },
  gold: { region: 'johto', version: 'gold' },
  silver: { region: 'johto', version: 'silver' },
  crystal: { region: 'johto', version: 'crystal' },
  ruby: { region: 'hoenn', version: 'ruby' },
  sapphire: { region: 'hoenn', version: 'sapphire' },
  emerald: { region: 'hoenn', version: 'emerald' },
  diamond: { region: 'sinnoh', version: 'diamond' },
  pearl: { region: 'sinnoh', version: 'pearl' },
